...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('casualmatch')
    .setDescription('Start a casual match (MMR is not affected).')
    .setDescriptionLocalizations({
      ko: '캐주얼 매치를 시작합니다. (MMR에 영향 없음)',
      ja: 'カジュアルマッチを開始します（MMRに影響なし）',
      zh_CN: '开始休闲比赛（不影响MMR）',
      zh_TW: '開始休閒對戰（不影響MMR）',
      en_US: 'Start a casual match (MMR not affected).',
    })
